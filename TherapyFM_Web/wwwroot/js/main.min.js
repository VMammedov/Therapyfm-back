...
$.extend($.easing, {
  ...
  (Riode.setCookie = function (e, t, i) {
    ...
    o.setTime(o.getTime() + 24 * i * 60 * 60 * 1e3),
      (document.cookie =
        e + "=" + t + ";expires=" + o.toUTCString() + ";path=/");
  }),
    ...
    $.fn.themePluginParallax &&
      Riode.$(e).each(function () {
        ...
        e.themePluginParallax(
          $.extend(!0, Riode.parseOptions(e.attr("data-parallax-options")), t)
        );
      });
  }),
  ...
  (Riode.playableVideo = function (e) {
    $(e + " .video-play").on("click", function (t) {
      ...
      i.hasClass("playing")
        ? i.removeClass("playing").addClass("paused").find("video")[0].pause()
        : i.removeClass("paused").addClass("playing").find("video")[0].play(),
        t.preventDefault();
    }),
  ...
  (Riode.ratingTooltip = function (e) {
    for (
      ...
      t[n].addEventListener("mouseover", o),
        t[n].addEventListener("touchstart", o);
  }),
        ...
        return (
          ...
          t.$sidebar.length &&
            ((t.isNavigation =
              ...
              t.$sidebar.parent().hasClass("toolbox-wrap")),
            t.isNavigation &&
              ((i = i.bind(this)), Riode.$window.on("resize", i)),
            ...
            t.$sidebar
              ...
              .add(
                "sidebar" === e ? ".left-sidebar-toggle" : "." + e + "-toggle"
              )
              .on("click", function (e) {
                t.toggle(),
                  $(this).blur(),
              ...
              if (i.hasClass("product-lists"))
                ...
                var o = i.data("toggle-cols"),
                  ...
                  a = n
                    ...
                    : 0;
                t
                  ? 4 === a && 3 == o && i.removeClass("cols-md-4")
                  : 3 === a &&
                    (i.addClass("cols-md-4"), o || i.data("toggle-cols", 3));
              }
          }
  ...
  (Riode.initProductSingle = (function () {
    ...
    var t = function (e) {
        ...
        i >= t + e.$productThumb[0].offsetHeight
          ? (e.$thumbs.css(
              "top",
              parseInt(e.$thumbs.css("top")) - e.$productThumb[0].offsetHeight
            ),
                ...
                e.$thumbs.hasClass("owl-carousel") ||
                  e.$thumbs
                    ...
                    .owlCarousel(
                      $.extend(
                        !0,
                        e.isQuickview ? { onInitialized: n, onResized: n } : {},
    ...
    return (
                ...
                (function (e) {
                  (e.$thumbs = e.$wrapper.find(".product-thumbs")),
                    ...
                    e.$thumbsDots.on("click", function () {
                      var t = $(this),
                        i = (
                          t.parent().filter(e.$thumbs).length ? t : t.parent()
                        ).index();
                      e.$wrapper
      ...
      (e.prototype.thumbsSetActive = function (e) {
        ...
        if (
          (this.$thumbsDots.filter(".active").removeClass("active"),
          t.addClass("active"),
          this.thumbsIsVertical)
        ) {
          var i = parseInt(this.$thumbs.css("top")) + e * this.thumbsHeight;
          i < 0
            ? this.$thumbs.css("top", parseInt(this.$thumbs.css("top")) - i)
            : (i =
                this.$thumbs.offset().top +
                this.$thumbs[0].offsetHeight -
                t.offset().top -
                t[0].offsetHeight) < 0 &&
              this.$thumbs.css("top", parseInt(this.$thumbs.css("top")) + i);
      ...
      (e.prototype.variationMatch = function () {
        this.$priceWrap
          ...
          this.$btnCart.removeAttr("disabled");
      }),
      ...
      if (
        ...
        var o = t
          ...
          n = i
            ...
            .data("owl.carousel"),
          a = n
            ? (n.current() - n.clones().length / 2 + o.length) % o.length
  ...
  (Riode.slider = (function () {
    ...
    var t = function (e) {
        ...
        if (
          ...
          for (var o = this.children, n = o.length, a = 0; a < n; ++a)
            o[a].setAttribute("data-index", a + 1);
      },
      i = function (e) {
        var t,
        ...
        for (t = 0; t < o; ++t)
          if (!i[t].classList.contains("active")) {
            ...
            for (n = a.length - 1; n >= 0; --n)
              a[n].classList.remove("appear-animate");
          }
        ...
        if (1 == t.translateFlag) {
          if (
            ...
            if (
              ...
              for (var o = 0; o < t.timers.length; o++)
                Riode.deleteTimeout(t.timers[o]);
              t.timers = [];
            }
          ...
          (r.appendTo(e).css("top", -t).find("img")[0].onload = function () {
            (t += r[0].offsetHeight + l.space),
              ...
              r.offset().top - window.pageYOffset < 0 &&
                (l.close(), r.css("top", -t + r[0].offsetHeight + l.space)),
              r
                      ...
                      if (6 == s.length)
                        return (
                          "C" == a
                            ...
                            : ((s[1] += e.getDeltaY(i + s[0]) - o),
                              (s[3] += e.getDeltaY(i + s[2]) - o),
                              (s[5] += e.getDeltaY((i += s[4])) - o)),
                          (o = e.getDeltaY(i)),
                          a +
                            s
                              .map(function (e) {
        ...
        Riode.$(t).each(function () {
          ...
          "svg" == this.tagName &&
            ((t = i.data("float-svg"))
              ...
              : i.data("float-svg", new e(this, i.attr("data-float-options"))));
        });
      }
    );
  })()),
        ...
        $(Riode.byClass("product-slideup-content"))
          ...
          .on("mouseleave touchleave", function (e) {
            ...
            t.find(".product-details").css("transform", "translateY(0)"),
              t.find(".product-hide-details").css("transform", "translateY(0)");
          }));
    },
